...
public class Last_socketNEtwork : MonoBehaviour
{
    ...
    //        Session.RoomID = json.rid;

    //        m_socket.Emit("srv_getAllRoomPlayers", new JSON.Room() { RoomID = Session.RoomID });
    //    });
